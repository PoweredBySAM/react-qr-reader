...
module.exports = class Reader extends Component {
  ...
  check() {
    ...
    if (legacyMode || previewIsPlaying) {
      ...
      // Cordova plugin cordova-plugin-iosrtc has made drawImage asynchronous.
      // https://github.com/cordova-rtc/cordova-plugin-iosrtc/issues/676
      // To get around that, we keep calling getImageData until the first item in the
      // data array is not 0.
      const checkImage = () => {
